...
class SubstanceExtractor:
    ...
    # Diese Funktion parst eine einzelne Zeile und gibt die Substanzdaten zurück.
...
if __name__ == "__main__":
    ...
    extractor.run()
    print("Datenextraktion abgeschlossen. Die Ergebnisse sind in substancesTest.json gespeichert.")
