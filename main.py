        ...
        for substance in self.substances:
            ...
            if smiles:
                ...
                if molecule:
                    ...
                    try:
                        molecular_mass_valid = abs(float(substance["molecular_mass"]) - calculated_molecular_mass) < 0.05   # Absolute Differenz, Wert notfalls anpassen für die Toleranz
                    except ValueError:
...
if __name__ == "__main__":
    ...
    extractor.run()
    print("Datenextraktion und Validierung abgeschlossen. Die Ergebnisse sind in substances.json gespeichert.")
